...
// Unified camelCase format (V2 style)
export type RelayerV1KeyData = { dataId: string; urls: Array<string> };
export type RelayerV1KeyInfo = { fhePublicKey: RelayerV1KeyData };
export type RelayerV1KeyUrlResponse = {
  response: {
    fheKeyInfo: Array<RelayerV1KeyInfo>;
